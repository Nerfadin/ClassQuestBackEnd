...
let PvPFacade = class PvPFacade {
    async getPvPQuests(questAmount, playerId) {
        const answredQuests = (0, firestoreUtils_1.manyDocuments)(await app_1.adminDb.collection(QuestFirebaseAdaptor_1.PLAYERS).doc(playerId).collection(QuestFirebaseAdaptor_2.ANSWERS).get());
